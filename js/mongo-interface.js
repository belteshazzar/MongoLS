...
/**
 * MongoInterface (Namespace)
 */
var MongoInterface = (function () {

	/**
	 * MongoInterface.copy (Private Function)
	 */
	function copy(o) {
	   var out, v, key;
	   out = Array.isArray(o) ? [] : {};
	...
	/**
	 * MongoInterface.getProp (Private Function)
	 */
	...
	/**
	 * MongoInterface.DB (Public Constructor)
	 */
	this.DB = function(options) {

		/**
		 * MongoInterface.DB.log (Private Function)
		 * 
		 * @param {String} msg The message to display.
		 */
		function log(msg) {
			if (options.print) options.print(msg);
			else console.log(msg);
		}

		/**
		 * MongoInterface.DB.id (Private Function)
		 */
		function id() {
		...
		/**
		 * MongoInterface.DB.toArray (Private Function)
		 */
		...
		/**
		 * MongoInterface.DB.arrayMatches
		 * 
		 * Private Function
		 */
		...
		/**
		 * MongoInterface.DB.objectMatches
		 * 
		 * Private Function
		 */
		...
		/**
		 * MongoInterface.DB.applyProjection
		 * 
		 * Private Function
		 */
		...
		/**
		 * MongoInterface.DB.applyUpdates
		 * 
		 * Private Function
		 */
		...
		/**
		 * MongoInterface.DB.createDocFromUpdate
		 * 
		 * Private Function
		 */
		...
		function Collection(db,storage) {
			...
			/**
			 * MongoInterface.DB.Collection.Cursor
			 * 
			 * Private Constructor Function
			 */
			...
			/**
			 * MongoInterface.DB.Collection.SortedCursor
			 * 
			 * Private Constructor Function
			 */
			...
			}; // MongoInterface.DB.Collection return
		}; // MongoInterface.DB.Collection
		...
		return {
			...
			createCollection : function(name) {
				...
				else this[name] = new Collection(this,(options.storage?new options.storage():new ObjectStore()));
			},
			currentOp : function() { throw "Not Implemented"; },
			dropDatabase : function() {
				for (var key in this) {
					if (this[key].isCollection) {
			...
			localStorage : new Collection(this,LocalStorageStore),
		...
		}; // MongoInterface.DB return

	}; // MongoInterface.DB

	/**
	 * MongoInterface.ObjectStore
	 * 
	...
	this.ObjectStore = function() {
		...
		}; // MongoInterface.ObjectStore return
	}; // MongoInterface.ObjectStore
	
	/**
	 * MongoInterface.LocalStorageStore
	 * 
	 * Singleton
	 */
